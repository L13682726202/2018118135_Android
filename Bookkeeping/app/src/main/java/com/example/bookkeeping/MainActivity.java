...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    com.example.bookkeeping.adapter.AccountAdapter adapter;
    int year,month,day;
    //头布局相关控件
    View headerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置适配器：加载每一行数据到列表当中
        adapter = new com.example.bookkeeping.adapter.AccountAdapter(this, mDatas);
    ...
    private void addLVHeaderView() {
        ...
        //查找头布局可用控件
        topOutTv = headerView.findViewById(R.id.item_main_lv_top_tv_expend);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.main_btn_more:
                com.example.bookkeeping.utils.MoreDialog moreDialog = new com.example.bookkeeping.utils.MoreDialog(this);
                moreDialog.show();
                moreDialog.setDialogSize();
                break;
            case R.id.item_main_lv_top_tv_budget:
                showBudgetDialog();
                break;
            case R.id.item_main_lv_top_iv_hide:
                //切换TextView明文和密文
                toggleShow();
                break;
        }
