...
import com.example.bookkeeping.frag_chart.ExpendChartFragment;
...
public class MonthChartActivity extends AppCompatActivity {
    ...
    private ExpendChartFragment outcomChartFragment;
    ...
    private void initFrag() {
        ...
        outcomChartFragment = new ExpendChartFragment();
        //添加数据到Fragment当中
